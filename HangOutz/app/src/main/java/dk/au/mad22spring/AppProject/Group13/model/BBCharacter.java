...
public class BBCharacter {
    ...
    @Expose
    private String betterCallSaulAppearance = null;
    ...
    public String getBetterCallSaulAppearance() {
        return betterCallSaulAppearance;
    }

    public void setBetterCallSaulAppearance(String betterCallSaulAppearance) {
